...
//import com.open.library.progresslayout.ProgressLayout;
...
//            mProgressLayout = getLoadingTargetView();
//        }
...
//    }
     ...
     */
//    protected abstract ProgressLayout getLoadingTargetView();
    ...
    protected void showToast(String msg) {
        if (null != msg && !TextUtils.isEmpty(msg)) {
            Snackbar.make(((Activity) mContext).getWindow().getDecorView(), msg, Snackbar
                    .LENGTH_SHORT).show();
        }
    }
