 ...
 */
public class UserPinListPresenter extends AbstractPinListPresenter {

    public UserPinListPresenter(@NonNull PinContract.PinListView view, @NonNull PetalRepository
            repository) {
    ...
    public void callRepository(String id, int limit, String key, String pinId, RequestCallback<PinList> callback) {
        mRepository.getUserPins(id, limit, key, pinId, callback);
    }
}
